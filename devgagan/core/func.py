...
async def subscribe(app, message):
   ...
   if update_channel:
      try:
        ...
        await message.reply_photo(photo="https://files.catbox.moe/mgz7iq.jpg",caption=caption, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Join Now...", url=f"{url}")]]))
        return 1
      except Exception:
